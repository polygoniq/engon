...
TAGS = {
    ...
    "AI Assisted": {"description": "Asset that was created or modified using AI tools"},
    "Adult": {"description": ""},
    "Afro-descendant": {"description": ""},
    "Animal": {"description": ""},
